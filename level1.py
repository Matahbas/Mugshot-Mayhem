...
ground_texture, sky_texture, enemy_texture, player_texture, enemy_ray_texture = load_assets(1)


#Factory method
class CharacterFactory:
    #Encapsulation: private attribute _instance
    _instance = None

    #Singleton: ensures that only one instance of CharacterFactory is instantiated 
    def __new__(cls):
...
#Inheritance: inherits properties and methods from Character class
...
#Composition: class is composed of 'Ray' objects. This composition allows the 'RayGroup' to manage
#and update multiple 'Ray' objects simultaneously.
    ...
    def draw(self, surface):
        for ray in self.sprites():
            if isinstance(ray.owner, Enemy):
                ...
                pygame.draw.rect(surface, BLACK, ray.rect)
...
class Level1:
    ...
    def update(self):
        ...
        if self.player.health > 0:
            #Polymorhism: overrides the draw_health_bar method from Character class
        ...
        if self.enemy.health > 0:
            ...
            self.display_message("Press 'ENTER' to continue to Level 2", 60, (0, 255, 0), (self.screen_width // 2, self.screen_height // 2 + 70))
            self.enemy.can_shoot = False
